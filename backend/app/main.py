...
async def submit_contact(request: Request):
    ...
    if len(message) < 10:
        return JSONResponse(
            {"ok": False, "error": "Could you tell us a bit more? Your message is too short."},
            status_code=400,
        )
...
async def send_pdf(payload: SendPdfRequest, request: Request):
    ...
    send_email(
        ...
        text_body=(
            ...
            "Visit https://www.petromac.co.nz for more information."
        ),
        html_body=(
            ...
            '<a href="https://www.petromac.co.nz" style="color: #1e40af;">www.petromac.co.nz</a></p>'
            '</div>'
        ),
