        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="space-y-4">
            <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <Link
                href="/about/patents"
                className="block p-4 mb-3 border border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition-colors"
              >
                <h4 className="text-lg font-semibold text-gray-900 mb-1">Patents</h4>
                <p className="text-sm text-gray-600">View our innovative patents</p>
              </Link>
              ...
              >
                <h4 className="text-lg font-semibold text-gray-900 mb-1">Publications</h4>
                <p className="text-sm text-gray-600">Browse our research papers</p>
              </Link>
            </div>
          </div>
        </div>
