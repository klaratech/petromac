  ...
  return (
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <div className="max-w-7xl mx-auto px-6 pt-8 pb-16">
        <h1 className="text-4xl md:text-5xl font-bold mb-8 text-slate-100 text-center">
          Petromac&apos;s intellectual property
        </h1>
        
        <div className="mb-12 bg-white rounded-lg p-6 border border-gray-200 text-gray-800">
        ...
        <div className="mb-16">
          ...
          {wirewireExpressPatents.map((category, categoryIndex) => (
            <div key={categoryIndex} className="mb-8">
              ...
              <div className="bg-white rounded-lg shadow-xl overflow-hidden border border-white/20 max-w-5xl mx-auto">
