...
export const regionalManagers: TeamContact[] = [
  ...
  },
  {
    ...
    emailUser: 'javier',
    emailDomain: 'petromac.co.nz',
    // TODO(copy): placeholder pending Javier's approved bio — structure
    // matches the other profiles but avoids specific employers/dates we
    // haven't confirmed. Replace with copy from Javier/marketing.
    bio: "Javier leads Petromac's business across Europe and the CIS, working with operators and wireline companies on conveyance, centralisation, and data-quality challenges. He brings extensive regional wireline experience, and helps clients plan and deliver logging programmes in demanding wellbore conditions.",
...
export const hqTeam: TeamContact[] = [
  ...
  },
  {
    ...
    emailUser: 'rolando',
    emailDomain: 'petromac.co.nz',
    bio: 'Rolando brings 14+ years of Schlumberger experience, from field engineering across South America to deepwater projects in Trinidad and Tobago. At Petromac he leads operations with a focus on quality and process optimisation.',
