  ...
  return (
    <div className="prose prose-lg max-w-none text-slate-700 space-y-6">
      ...
      <p>
        ...
        privacy laws that may apply to visitors or customers outside New
        Zealand.
      </p>
      ...
      <p>
        We use Google Analytics to understand website performance and visitor
        trends, such as which pages are visited, approximate location, and
        device and browser type. Google Analytics sets its own cookies and may
        process this information outside New Zealand. We may also use Cloudflare
        for website security, performance, and traffic analytics. Where required
        by applicable law, we will provide any additional notice or consent
        mechanism needed for these tools, and you can opt out of Google
        Analytics using the browser add-on Google provides.
      </p>
      ...
      <p>
        ...
        the purposes described above, unless a longer period is required and
