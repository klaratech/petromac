const outputs = [
  "Sticking-risk interval",
  "Tension and drag behavior",
      ...
      <div className="mx-auto grid max-w-6xl gap-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
        ...
        <div>
          ...
          <h2 className="mb-4 font-heading text-3xl font-bold text-white md:text-4xl">
            Watch the job become a decision.
          </h2>
          <p className="text-lg leading-relaxed text-slate-300">
            The demo should show the practical payoff quickly: where the run
            gets difficult, which scenario improves the margin, and what the
            team should do next.
          </p>

          <div className="mt-7 grid gap-3 sm:grid-cols-2">
            {outputs.map((output) => (
              <div key={output} className="rounded-md border border-slate-700 bg-slate-900 p-4">
