  ...
  return (
    <section className="py-20 px-6 bg-white scroll-reveal">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-base md:text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed mb-14">
          Trusted by <span className="font-semibold text-slate-900">all major IOCs and NOCs</span>{' '}
          worldwide.
        </p>
