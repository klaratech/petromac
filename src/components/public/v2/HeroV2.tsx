  ...
  return (
    <section className="relative h-[90vh] min-h-[600px] overflow-hidden">
      {/* Background video (desktop) / static image (mobile).
          ...
          — generated by `ffmpeg -ss 20 -i ... -frames:v 1`. The old sampling.jpg
          was a black-canvas dev placeholder with the word "Sampling" stenciled
          in the top-left, which showed through on mobile (where the video is
          hidden) and during the desktop video's autoplay buffer. */}
