...
> **Note**: The main project README is at [../README.md](../README.md) (repository root).

## Docs

- [../DEPLOY.md](../DEPLOY.md) - Deploy model: push → test, production via the Promote workflow
...
- [ADMIN.md](ADMIN.md) - Recurring content updates
- [FLIPBOOKS.md](FLIPBOOKS.md) - Flipbook build pipeline
